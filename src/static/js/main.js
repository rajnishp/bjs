! function(a) {
    ...
    var b = {
        ...
        init: function() {
            if (!this.initialised) {
                this.initialised = !0, this.queryLoad(), this.checkMobile(), this.videoBg(), this.checkPlaceholder(), this.fitTexts(), this.scrollAnimations(), this.homeSectionHeight(), this.menuScrollToAnimation(), this.stickyMenu(), this.collapseIcons(), this.countdowns(), this.owlCarousels(), this.singlePortfolioOwl(), this.scrollToTopAnimation(), this.scrollToClass(), this.selectBox(), this.bootstrapSwitch(), this.tooltip(), this.popover(), this.countTo(), this.progressBars(), this.registerKnob(), this.prettyPhoto(), this.flickerFeed(), this.contactForm(), this.parallax(), this.twitterFeed(), this.contactFormFixes();
                var a = this;
                "function" == typeof imagesLoaded && (imagesLoaded(a.container, function() {
                    a.calculateWidth(), a.isotopeActivate(), a.scrollTriggerforPortfolioAnim(), a.prettyPhoto(), a.hoverAnimation(), a.isotopeFilter(), a.openProject()
                }), imagesLoaded(a.blogContainer, function() {
                    a.masonryBlog()
                }))
            }
        },
        ...
        videoBg: function() {
            if (this.mobile) a("#home").hasClass("videobg") && a("#home").addClass("homebg"), a("#videobg-container").addClass("videobg");
            else {
        ...
        countdowns: function() {
            if (a.fn.countdown) {
                var b = new Date;
                b = new Date(b.getFullYear() + 1, 2, 1), a("#event-countdown").countdown({
                    until: b
                })
            }
        },
        ...
        singlePortfolioOwl: function() {
            function b(b) {
                ...
                a(".slider-thumb-nav.owl-carousel").find(".owl-item").removeClass("active").eq(d).addClass("active"), void 0 !== a(".slider-thumb-nav.owl-carousel").data("owlCarousel") && c(d)
            }
            ...
            }), (e.length || f.length) && a(".slider-thumb-nav.owl-carousel").on("click", ".owl-item", function(b) {
                b.preventDefault();
        ...
        menuScrollToAnimation: function() {
            var b = this;
            a("#main-menu").find("a").on("click", function(c) {
                b.scrollToAnimation.call(this, 1e3, 0, c), a(this).closest("li").addClass("active").siblings().removeClass("active")
            })
        },
...
/*                submitHandler: function(b) {
                    return a.ajax({
                        ...
                        "success" == a ? alert("Email has been sent successfully!") : "already" == a ? alert("You already sent a message. Please try again later") : alert("There is an error please try again later!")
                    }).error(function() {
        ...
        contactFormFixes: function() {
            ...
            b.find("input, textarea").on("blur", function() {
                var b = a(this),
                    c = b.val(),
                    d = b.siblings(".animated-label");
                "" !== c ? d.addClass("not-empty") : d.removeClass("not-empty")
            }), b.find('input[type="reset"]').on("click", function() {
        ...
        calculateWidth: function() {
            ...
            b = c > 1170 ? e ? e : 5 : c > 960 ? e ? e > 4 ? 4 : 3 : 4 : c > 767 ? 3 : c > 540 ? 2 : 1;
        ...
        elementsAnimate: function() {
            ...
            this.container.find(".animate-item").each(function() {
                var b = a(this),
                    f = b.data("animate-time");
                ++e, setTimeout(function() {
                    b.addClass("animated " + c)
                }, f), e === d && (this.portfolioItemsAnimated = !0)
        ...
        openProject: function() {
            var b = this,
                c = a("#portfolio-single-content");
            c.find(".single-portfolio");
            a(".open-btn").on("click", function(d) {
                d.preventDefault();
                var e = a(this),
        ...
        loadProject: function(c, d) {
            ...
            a.when(g).done(function(e) {
                c.animate({
                    ...
                    a("html, body").animate({
                        scrollTop: b
                    }, 700), a('[data-spy="scroll"]').each(function() {
                        a(this).scrollspy("refresh")
                    }), d.addClass("active")
                }), b.closeProject(), b.singlePortfolioOwl()
            }), c.load(f + " #project-content", function(a, b, c) {
                g.resolve()
            })
        },
        closeProject: function() {
            var b = this,
                c = a("#portfolio-single-content");
            c.find(".single-portfolio");
            a(".portfolio-close").on("click", function(d) {
                a(c).animate({
                    height: "hide"
                }, 400, function() {
                    b.container.find(".portfolio-item.active").removeClass("active"), a(this).html("")
                }), d.preventDefault()
            })
        }
    };
    b.init(), a(window).on("load", function() {}), a(window).on("scroll", function() {
        b.scrollTopBtnAppear()
    }), a.event.special.debouncedresize ? a(window).on("debouncedresize", function() {
        b.homeSectionHeight(), b.calculateWidth(), b.isotopeReinit(), b.scrollSpyRefresh()
...
/*(window, document, "script", "//www.google-analytics.com/analytics.js", "ga"), ga("create", "UA-57177726-2", "auto"), ga("require", "displayfeatures"), ga("send", "pageview"), -1 === window.location.origin.indexOf("eonythemes") && (window.location.href = "http://eonythemes.com/themes/wb/geass1/")*/;