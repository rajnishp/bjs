...
<section id=\"hire".$keyAll."\" class=\"section padding-bottom\" style=\"".$temp."  overflow-y: hidden ! important;
                                                            overflow-x: hidden ! important;
                                                        background-image: url('http://api.file-dog.shatkonlabs.com/files/rahul/".$value['img']."');
                                                        background-size:     contain;                      /* <------ */
                                                        background-repeat: no-repeat;
                                                            background-position: top;\">
