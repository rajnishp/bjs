                                    ...
                                    <div class="pricing-table-container">
                                        <div class="pricing-table active">
                                            ...
                                            <ul class="pricing-list">
                                                <h4 class="lightblue" style="margin-bottom: 0px;">Maid</h4>
                                                <li> 4 BHK - <i class="fa fa-inr"> 3499 </i> </li>
                                                <li> 3 BHK - <i class="fa fa-inr"> 2999 </i> </li>

                                            </ul>
                                            <ul class="pricing-list">
                                                <h4 class="lightblue" style="margin-bottom: 0px;">Cook</h4>
                                                <li><i class="fa fa-inr"></i> 3500  one time</li>
                                                <li><i class="fa fa-inr"></i> 6000 </i> two time</li>
                                            </ul>



                                            <ul class="pricing-list" style="margin-bottom: 0px;">
                                                <h4 class="lightblue">Driver</h4>
                                                <li> <i class="fa fa-inr"></i> 15000/10hr</li>
                                            </ul>
                       ...
                       <!--     </div>
                            ...
                            <div class="tp-caption rev-subtitle bigger fancy customin customout blue-color"
                                ...
                                <div class="pricing-table active">
                                    ...
                                    <ul class="pricing-list">
                                        <h4 class="lightblue" style="margin-bottom: 0px;">Driver</h4>
                                        <li>199 <i class="fa fa-inr"></i>/ hour</li>
                                    </ul>

                                    <ul class="pricing-list">
                                        <h4 class="lightblue" style="margin-bottom: 0px;">Electrician</h4>
                                        <li>199 <i class="fa fa-inr"></i>/ hour</li>
                                    </ul>
...
=======
    ...
    <!--                 </div>
>>>>>>> c9b840480bf5fab6d512053eb783daac630fe4f4
                            ...
                            <div class="tp-caption rev-title big customin customout blue-color"
                                data-x="center"
                                data-y="220"
                                data-speed="1100"
                                data-customin="x:0;y:0;z:0;rotationX:-90;rotationY:0;rotationZ:0;scaleX:1;scaleY:1;skewX:0;skewY:0;opacity:0;transformPerspective:200;transformOrigin:50% 0%;"
    ...
    <section id="home" class="section gfullscreen" style="background-color: #2aafc3;width:100%;height:100%;">
        ...
        <div id="our-services" style="margin-top:130px" >
            <div class="container" >
                <img src="http://api.file-dog.shatkonlabs.com/files/rahul/1052" style="width: 400px"/ >
    ...
    <section id="hire" class="section padding-bottom" style="padding-top: 115px;">
        <header class="container text-center">
            <h1 class="section-title fancy">One Touch Services</h1>
...
//  curl_setopt($ch,CURLOPT_HEADER, false);
            ...
            foreach( $result as $keyAll => $value ){
                //$temp = ($keyAll%2 == 0)?"background-color: #2aafc3;":"";
                $data = "

<section id=\"hire".$keyAll."\" class=\"section padding-bottom\" style=\"".$temp."\">
        <header class=\"container text-center\">
...
<center>";
                        ...
                        <div class=\"service box lightblue wow fadeInUp\" data-wow-delay=\"0.75s\">
                            <div class=\"service-header\">
                                <span class=\"service-icon\" style='background-color: #fff'>
                                    <img class=\"service-request-image\" src=\"http://api.file-dog.shatkonlabs.com/files/rahul/".$service['pic_id']."\" alt=\"Maid\" style=\"width: 50px;height: 50px\">
                                </span>
                ...
                " ;
                    if(($key+1)%6 == 0){
                       $data = $data. "</center></div><div class='row'>";
                    }
                }
    ...
    <!-- Services Section -->
   <?php /* <section id="services" class="section">
        <header class="container text-center">
